...
# Saved on Fri Aug 5 15:55:53 2022
...
gui_load_child_values {rkv_gpio_tb.dut.u_iop_gpio}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 232000
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ${GPIO|INTQ}  -item {rkv_gpio_tb.dut.u_iop_gpio.reg_inten[15:0]} -position below
