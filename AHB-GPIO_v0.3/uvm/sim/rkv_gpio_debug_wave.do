...
# Saved on Sun Jul 24 21:49:00 2022
...
gui_sg_addsignal -group "$_wave_session_group_1" { {Sim:rkv_gpio_tb.dut.ECOREVNUM} {Sim:rkv_gpio_tb.dut.GPIOINT} }

set _wave_session_group_2 $_wave_session_group_1|
append _wave_session_group_2 Group5
set Group3|Group5 "$_wave_session_group_2"
...
append _wave_session_group_3 Group6
set Group3|Group6 "$_wave_session_group_3"
...
append _wave_session_group_4 Group4
set Group3|Group4 "$_wave_session_group_4"
...
gui_wv_zoom_timerange -id ${Wave.1} 0 899
gui_list_add_group -id ${Wave.1} -after {New Group} [list ${Group1}]
gui_list_add_group -id ${Wave.1}  -after ${Group1} [list ${Group3|Group5}]
gui_list_add_group -id ${Wave.1} -after Group3|Group5 [list ${Group3|Group6}]
gui_list_add_group -id ${Wave.1} -after Group3|Group6 [list ${Group3|Group4}]
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ${Group3|Group5}  -item {rkv_gpio_tb.dut.PORTFUNC[15:0]} -position below
