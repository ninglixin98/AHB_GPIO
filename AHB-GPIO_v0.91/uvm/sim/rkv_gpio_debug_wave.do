...
# Saved on Sat Aug 6 16:40:07 2022
...
set _wave_session_group_1 GPIO
...
set GPIO|PORT "$_wave_session_group_2"
...
set GPIO|INTQ "$_wave_session_group_3"

gui_sg_addsignal -group "$_wave_session_group_3" { {Sim:rkv_gpio_tb.dut.GPIOINT} {Sim:rkv_gpio_tb.dut.COMBINT} {Sim:rkv_gpio_tb.dut.u_iop_gpio.rise_edge_int} {Sim:rkv_gpio_tb.dut.u_iop_gpio.fall_edge_int} {Sim:rkv_gpio_tb.dut.u_iop_gpio.low_level_int} {Sim:rkv_gpio_tb.dut.u_iop_gpio.high_level_int} {Sim:rkv_gpio_tb.dut.u_iop_gpio.reg_inten} {Sim:rkv_gpio_tb.dut.u_iop_gpio.reg_inttype} {Sim:rkv_gpio_tb.dut.u_iop_gpio.reg_intpol} {Sim:rkv_gpio_tb.dut.u_iop_gpio.new_raw_int} {Sim:rkv_gpio_tb.dut.u_iop_gpio.new_masked_int} }
...
set GPIO|AHB "$_wave_session_group_4"
...
gui_wv_zoom_timerange -id ${Wave.1} 0 235667
gui_list_add_group -id ${Wave.1} -after {New Group} [list ${Group1}]
gui_list_add_group -id ${Wave.1}  -after ${Group1} [list ${GPIO|PORT}]
gui_list_add_group -id ${Wave.1} -after GPIO|PORT [list ${GPIO|INTQ}]
gui_list_add_group -id ${Wave.1} -after GPIO|INTQ [list ${GPIO|AHB}]
gui_list_add_group -id ${Wave.1} -after {New Group} [list ${Group2}]
gui_list_add_group -id ${Wave.1} -after {New Group} [list ${Group3}]
gui_list_expand -id ${Wave.1} rkv_gpio_tb.dut.PORTIN
gui_list_select -id ${Wave.1} {rkv_gpio_tb.gpio_if.portin }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ${GPIO|INTQ}  -item {rkv_gpio_tb.dut.u_iop_gpio.reg_intpol[15:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 160225
